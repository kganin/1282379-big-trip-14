...
const createEditEventOfferListTemplate = (offers) => {
  return `
  <section class="event__section  event__section--offers">
    <h3 class="event__section-title  event__section-title--offers">Offers</h3>
    <div class="event__available-offers">${offers.map(createEditEventOfferTemplate).join('')}</div>
    </div>
  </section>
  `;
};
...
const createEditEventTemplate = ({type, destination, offers, price, dates}) => {
  ...
  <form class="event event--edit" action="#" method="post">
    ...
    <section class="event__details">
      <section class="event__section  event__section--offers">
        ${offers.length > 0 ? createEditEventOfferListTemplate(offers) : ''}
      <section class="event__section  event__section--destination">
        ${destination.photos != [] && destination.description != '' ? createEditEventPhotosListTemplate(destination) : ''}
      </section>
    </section>
  </form>
</li>`;
